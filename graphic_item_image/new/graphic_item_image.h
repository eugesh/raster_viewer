...
private:;
	...
	int band_min,band_max;//!< минимальное и максимальное значение пикселя слоя
	int mode_RSC;//!< метод ориентации растровой СК кадра относительно направления движения, допустимые методы ориентации растровой СК кадра относитедьно направления движения: 0,1
public:;
  //! конструктор
